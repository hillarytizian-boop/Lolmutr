...
def _write_env(values: dict[str, str]) -> None:
    ...
    lines = [
        ...
        f"TRADING_MODE={existing.get('TRADING_MODE', 'demo')}",
...
def run_setup(*, start: bool = False) -> None:
    ...
    if provider in PROVIDERS:
        ...
        if provider == "nvidia":
            ...
            if values.get("NVIDIA_API_KEY"):
                values["NVIDIA_NIM_API_KEY"] = values["NVIDIA_API_KEY"]
    else:
        values["LLM_PROVIDER"] = ""

    mode = _ask("Trading mode (demo/paper/testnet/live)", "demo").lower()
